...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'AstralWeb_AutoGenerateStockStatus' => 1,
        'AstralWeb_BannerManagement' => 1,
        'AstralWeb_BridgewellExport' => 1,
        'AstralWeb_BridgewellTracking' => 1,
        'AstralWeb_CategoryTitle' => 1,
        'AstralWeb_Core' => 1,
        'AstralWeb_DisableCategoryPage' => 1,
        'AstralWeb_DisableImageResize' => 1,
        'AstralWeb_Elasticsearch' => 1,
        'AstralWeb_Email' => 1,
        'AstralWeb_FaqSystem' => 1,
        'AstralWeb_FixElasticSearch' => 1,
        'Mirakl_Core' => 1,
        'AstralWeb_MiraklMessages' => 1,
        'AstralWeb_MiraklPromotions' => 1,
        'AstralWeb_MiraklShopDocuments' => 1,
        'AstralWeb_MiraklShopPages' => 1,
        'AstralWeb_Pages' => 1,
        'AstralWeb_ProductViewExtend' => 1,
        'AstralWeb_SitewideSearch' => 1,
        'AstralWeb_SortOptionsExtend' => 1,
        'AstralWeb_SyncOrder' => 1,
        'AstralWeb_SyncProductStatus' => 1,
        'AstralWeb_TWPrice' => 1,
        'AstralWeb_TapPay' => 1,
        'AstralWeb_Theme' => 1,
        'AstralWeb_UpdatePrice' => 1,
        'AstralWeb_UpdateProductStatus' => 1,
        'Carrefour_Checkout' => 1,
        'Carrefour_CheckoutCart' => 1,
        'Mirakl_Api' => 1,
        'Carrefour_Customer' => 1,
        'Carrefour_ExtendBannerManager' => 1,
        'Carrefour_OverrideMirakl' => 1,
        'Carrefour_ProductCharacter' => 1,
        'Carrefour_Recommend' => 1,
        'Mirakl_Connector' => 1,
